...
module.exports.$ = (attrValuePairs, _options = {}, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, '$');
...
module.exports.image = (attrValuePairs, _options = {}, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, 'image');
...
module.exports.link = (attrValuePairs, _options = {}, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, 'link');
...
module.exports.listItem = (attrValuePairs, _options = {}, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, 'listItem');
...
module.exports.button = (attrValuePairs, _options = {}, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, 'button');
...
function fileField(attrValuePairs, _options = {}, ...args) {
  validate();
  validateSelectorArgs(attrValuePairs, 'fileField');
...
function timeField(attrValuePairs, _options = {}, ...args) {
  validate();
  validateSelectorArgs(attrValuePairs, 'timeField');
...
function range(attrValuePairs, _options = {}, ...args) {
  validate();
  validateSelectorArgs(attrValuePairs, 'range');
...
function color(attrValuePairs, _options = {}, ...args) {
  ...
  validateSelectorArgs(attrValuePairs, 'color');
...
function tableCell(_options = {}, attrValuePairs, ...args) {
  ...
  validateSelectorArgs(attrValuePairs, 'tableCell');
...
function textBox(attrValuePairs, _options, ...args) {
  validate();
  validateSelectorArgs(attrValuePairs, 'textBox');
...
function dropDown(attrValuePairs, _options, ...args) {
  validate();
  validateSelectorArgs(attrValuePairs, 'dropDown');
...
module.exports.checkBox = (attrValuePairs, _options, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, 'checkBox');
...
module.exports.radioButton = (attrValuePairs, _options, ...args) => {
  validate();
  validateSelectorArgs(attrValuePairs, 'radioButton');
...
function text(text, _options = {}, ...args) {
  validate();
  validateSelectorArgs(text, 'text');
...
const validateSelectorArgs = (arg, selectorName) => {
